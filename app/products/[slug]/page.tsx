        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 mb-20">
          {category.subcategories.map((product, index) => (
            <Link
              key={index}
              href="/contact"
              className="group bg-surface border border-accent/20 rounded-2xl p-6 hover:shadow-2xl hover:border-accent/40 transition-all duration-300 hover:-translate-y-2"
            >
